...
\datedsubsection{\textbf{Face++} Beijing, China}{July. 2018 -- Present}
\role{Summer Internship}{Research Intern}
\begin{itemize}
  \item Work in the Face Recognition Group, Research Institute.
  \item Explore cluster algorithm and optimize the code.
\end{itemize}

\datedsubsection{\textbf{Google Summer of Code} Remote}{May. 2018 -- Present}
\role{Summer Programming}{Open Source Contributor}
\begin{itemize}
  \item 52 people from the mainland were selected in this year's GSoC.
  \item Contributing to the p5.js-web-editor by implementing a new console into it.
\end{itemize}
...
\datedsubsection{\textbf{Cluster}}{July. 2018 -- Present}
\role{Python}{Group Work}
\begin{itemize}
  \item Explore cluster algorithm and optimize the code.
\end{itemize}
...
\datedsubsection{\textbf{Insighter}}{Oct. 2017}
\role{Python, Vue}{Individual Project}
...
\datedsubsection{\textbf{Tango}}{June. 2017 -- Aug. 2017}
\role{Golang, Vue}{Individual Project}
\begin{itemize}
...
\datedline{\textit{\nth{3} Prize}, Award on i-lab hackathon}{Dec. 2017}
...
\datedline{\textit{\nth{2} Prize excellent scholarships}, Award on Shanghai Jiao Tong University}{Sep. 2016}
